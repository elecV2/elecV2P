...
module.exports = app => {
  app.get(["/logs", "/logs/*"], (req, res)=>{
    ...
    style = `:root {${ d_color.join('') };--main-fc: #FAFAFD;--delt-bk: #FF2828;--icon-run: #66FF00;--icon-bk: #66FF0088;--tras-bk: #A7A8BD88;scroll-behavior: smooth;}html,body{height: 100%;width: 100%;margin: 0;padding: 0;overflow: auto;}body{${appbk}}#app{padding: 3px 8px;box-sizing: border-box;min-height: 100vh;}${style}`
