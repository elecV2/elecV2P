...
module.exports = app => {
  app.get('/efss', (req, res)=>{
    ...
    <style>
      .efss {--main-bk: #003153;--main-fc: #F8F8FF;--secd-fc: #000000a6;--btn-bk: #E0F0E9;font-family: 'Microsoft YaHei', -apple-system, Arial;}.efss_file {overflow: hidden;width: 60%;font-size: 16px;}.efss_file::-webkit-file-upload-button {visibility: hidden;}.efss_file:before {content: '选择文件';display: inline-flex;padding: 6px 12px;align-items: center;justify-content: space-around;vertical-align: middle;border-radius: 8px;outline: none;white-space: nowrap;-webkit-user-select: none;cursor: pointer;font-size: 18px;text-align: center;box-sizing: border-box;background: var(--btn-bk);color: var(--secd-fc);}.efss_submit {border: none;background: var(--main-bk);color: var(--main-fc);padding: 6px 16px;border-radius: 8px;font-size: 16px;}.efssa{display: flex;justify-content: space-between;align-items: center;margin: 6px 0;padding: 1px;font-size: 18px;font-family: 'Microsoft YaHei', -apple-system, Arial;text-decoration: none;background: #FFF;color: #003153;border-bottom: 1px solid #00315388;}.efss_span{font-size:14px;}.efssa:hover>.efss_span{opacity:.6}.efss_form {display: flex;justify-content: space-around;align-items: center;height: 46px;border-radius: 8px;border: 1px solid var(--main-bk);}
    </style>
    </head>
